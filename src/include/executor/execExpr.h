...
#define FIELDNO_EXPREVALSTEPPARAMCALLBACK_PARAMARG 2
		...
		/* for EEOP_AGG_PLAIN_TRANS_{INIT_STRICT_,STRICT_,}{BYVAL,BYREF} */
		struct
		{
...
extern void ExecEvalFieldStoreForm(ExprState *state, const ExprEvalStep *op,
								   NullableDatum *opres, NullableDatum *columns);
extern bool ExecEvalSubscriptingRef(ExprState *state, const ExprEvalStep *op,
									NullableDatum *opres, NullableDatum *subscript);
extern void ExecEvalSubscriptingRefFetch(ExprState *state, const ExprEvalStep *op,
										 NullableDatum *opres);
extern void ExecEvalSubscriptingRefOld(ExprState *state, const ExprEvalStep *op,
									   NullableDatum *opres, NullableDatum *prev);
extern void ExecEvalSubscriptingRefAssign(ExprState *state, const ExprEvalStep *op,
										  NullableDatum *opres, NullableDatum *replace);
...
extern void ExecEvalSubPlan(ExprState *state, const ExprEvalStep *op,
							ExprContext *econtext,
							NullableDatum *opres);
extern void ExecEvalAlternativeSubPlan(ExprState *state, const ExprEvalStep *op,
									   ExprContext *econtext,
									   NullableDatum *opres);
