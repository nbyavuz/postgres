...
extern struct PgAioInProgress *FileStartRead(File file, char *buffer, int amount, off_t offset, int bufid, int mode);
extern int	FileWrite(File file, char *buffer, int amount, off_t offset, uint32 wait_event_info);
extern struct PgAioInProgress *FileStartWrite(File file, char *buffer, int amount, off_t offset, int bufid);
