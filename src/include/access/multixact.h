...
extern void multixactoffsetssyncfiletag(struct pg_streaming_write *pgsw, InflightSyncEntry *entry);
extern void multixactmemberssyncfiletag(struct pg_streaming_write *pgsw, InflightSyncEntry *entry);
