...
PageSetChecksumCopy(Page page, BlockNumber blkno, PgAioBounceBuffer **bb)
{
	...
	else if (!pageCopySync)
	{
		 ...
		 * call.  The point of palloc'ing here, rather than having a static
		 * char array, is first to ensure adequate alignment for the
		 * checksumming code and second to avoid wasting space in processes
